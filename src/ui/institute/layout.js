              ...
              <nav class="flex-1 overflow-y-auto py-6 px-3 no-scrollbar space-y-6">
                  <div>
                      ...
                      <ul class="space-y-1">
                          ...
                          <li>
                              <a href="/school/subjects" class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 group transition-colors">
