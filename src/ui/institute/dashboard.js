export function InstituteDashboardHTML(stats) {
    return `
      <div class="space-y-10 max-w-5xl mx-auto pt-6">
          ...
          <div>
            <h1 class="text-3xl font-light text-gray-900">Overview</h1>
            <p class="text-gray-500 mt-2 font-light">Welcome to your academic control center.</p>
          </div>

          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-b border-gray-100 py-8">
              <div>
                  <div class="text-xs uppercase tracking-widest text-gray-400 mb-2">Total Teachers</div>
                  <div class="text-4xl font-extralight text-gray-900">${stats.teachers || 0}</div>
              </div>
              <div>
                  <div class="text-xs uppercase tracking-widest text-gray-400 mb-2">Active Classes</div>
                  <div class="text-4xl font-extralight text-gray-900">${stats.classes || 0}</div>
              </div>
              <div>
                  <div class="text-xs uppercase tracking-widest text-gray-400 mb-2">Routines</div>
                  <div class="text-4xl font-extralight text-gray-900">0</div>
              </div>
              <div>
                  <div class="text-xs uppercase tracking-widest text-gray-400 mb-2">System Status</div>
          ...
          <div>
              ...
              <div class="flex flex-col md:flex-row gap-8 text-sm">
